      ...
      <section id="hero" className="min-h-screen flex items-center justify-center relative overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-8">
            <a href="mailto:sourabhdavarisoftwareengineer@gmail.com" className="bg-teal-600 hover:bg-teal-700 px-6 py-3 rounded-full transition-all duration-300 hover:scale-105 flex items-center gap-2">
            ...
            onClick={() => {
                ...
                link.href = '/sourabhdavari_softwareengineer.pdf';
                link.download = 'sourabhdavari_softwareengineer.pdf';
                document.body.appendChild(link);
                link.click();
                document.body.removeChild(link);
              }}
            className="border border-teal-400 hover:bg-teal-400/20 px-6 py-3 rounded-full transition-all duration-300 hover:scale-105 flex items-center gap-2">
          ...
          <div className={`transition-all duration-1000 ${isVisible.contact ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <div className="text-center mb-12">
              ...
              <div className="flex flex-wrap justify-center gap-6">
                <a href="mailto:sourabhdavarisoftwareengineer@gmail.com" className="bg-gradient-to-r from-teal-600 to-green-600 hover:from-teal-700 hover:to-green-700 px-8 py-4 rounded-full transition-all duration-300 hover:scale-105 flex items-center gap-3">
                  <Mail className="w-5 h-5" />
                  Email Me
                </a>
                <a href="https://www.linkedin.com/in/sourabh-davari-449509161/" className="border border-teal-400 hover:bg-teal-400/20 px-8 py-4 rounded-full transition-all duration-300 hover:scale-105 flex items-center gap-3">
